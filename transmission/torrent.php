...
class Torrent {
	...
	*/
	...
	/** Getter and setter of torrent media-info
	 * @param null|string name (optional, if omitted it's a getter)
	 * @return string|null name or null if not set
	 */
		
	
	public function file_media ( $file_media = null ) {
		return is_null( $file_media ) ?
			isset( $this->info['file-media'] ) ? $this->info['file-media'] : null :
			$this->touch( $this->info['file-media'] = (array) $file_media );
	}
	...
	protected function touch ( $void = null ) {
		...
		$this->{'created by'}		= 'autoseed robot by nanjifeng@gmail.com';
